...
def interact_with_miaoyin(events_log, clues, variables, lang="en"):
    ...
    while True:
        ...
        if choice == "1":
            ...
            #print("“我给他的，只是让心跳假停三日的‘三日息’，三日之后服下解药即可清醒。”")
            ...
            #print("\n她神情复杂：“当年我与他是师徒，他还未成亲，我爱慕他，却他却严词拒绝了。”")
            #print("“我一气之下叛出师门，拜了五毒教，后来经过一些事情，我们又遇见了。”")
            #print("“后来他说，这次假死之后，愿与我归隐。”")
            ...
            clues.add(say("clue_poison_bottleX2", lang)) # "毒药瓶x2" or two_poison_bottles
            ...
            #print("\n她摆摆手，神情憔悴：“希望阁下能早日破案，我也可以放下心结，早日去陪他。”")
