def interact_with_jing(events_log, clues, variables):
    """
    与静慧师太的多选互动模块
    ...
    while True:
        ...
        if choice == "1":
            print("\n静慧师太点点头：“，陈掌门是我多年好友，我受邀前来见证他二人之约，不过陈掌门已无杀心，这点我可以担保。”")
            ...
            chat_text = [
                "静慧师太无奈道：“近日玉泉院附近来了一些难民，”",
                "“玉泉院一直忙于安排他们住宿和释粥。”",
                "“三天前有人发现其中有些人得了伤寒，玉泉院一直在各处备药分发。”",
                "“院中事物繁复，灾民众多，故而来迟。”"
                ]
            ...
            if variables['truth_window_jing'] == True :
                chat_text = [
                    ...
                    "“是掌门，那天后半夜，弟子听见外面有一对男女在争执，好像说什么迟到之类的。”",
